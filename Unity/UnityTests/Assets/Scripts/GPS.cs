...
public class GPS : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (latitude != 0.0 || longitude != 0.0)
        {
            ...
            posY = Convert.ToSingle(latitude_scale * seno + longitude_scale * coseno); //rotaci�n del eje de coordenadas
            posX = Convert.ToSingle(latitude_scale * coseno - longitude_scale * seno); //rotaci�n del eje de coordenadas
        }
