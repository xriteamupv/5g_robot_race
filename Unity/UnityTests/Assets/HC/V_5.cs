...
public class V_5 : MonoBehaviour
{
    ...
    public GameObject particleObject; // Agrega una referencia al objeto que contiene el sistema de partículas
    ...
    void Start()
    {
        ...
        // Asegúrate de que el objeto de partículas esté desactivado al inicio
        ...
        {
            Debug.LogError("No se asignó ningún objeto de partículas.");
        }
    }
